      ...
      <div className="flip-card-grid">
        <FlipCard
          ...
          backText={{
            requirements: [
              t(
                "- You must have completed the Optimist or Laser initiation course at Sailing Academy."
              ),
            ...
            benefits: [
              ...
              t(
                "- 50% discount for renting Kayaks, Stand Up Paddles, and Sailboats."
              ),
        ...
        <FlipCard
          ...
          backText={{
            requirements: [
              t(
                "- You must have a previous year's FRY ID or have completed the adult sailing courses at Sailing Academy."
              ),
            ...
            benefits: [
              t("- Access card for Sailing Academy club."),
              t(
                "- 25% discount for renting Kayaks, Stand Up Paddles, and Sailboats."
              ),
              t("- FRY sports ID card."),
            ],
          }}
        ...
        <FlipCard
          ...
          backText={{
            ...
            benefits: [
              ...
              t(
                "- Right to store personal Kayak/Stand Up Paddle in the club's space."
              ),
            ],
          }}
          title="SIMPATIZANTI"
